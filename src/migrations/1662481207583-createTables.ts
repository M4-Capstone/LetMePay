...
export class createTables1662481207583 implements MigrationInterface {
    name = 'createTables1662481207583'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "transaction_categories" ("id" BIGSERIAL NOT NULL, "type" character varying(2) NOT NULL, CONSTRAINT "PK_bbd38b9174546b0ed4fe04689c7" PRIMARY KEY ("id"))`);
